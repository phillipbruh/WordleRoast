this.wordle = this.wordle || {}, this.wordle.bundle = function (e) {
            ...
            return o(t, [{
                key: "evaluateRow", value: function () {
                    if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                        ...
                        // make it so you cant type any letter if (e = s, !WORD_LIST.includes(e) && !SOLUTION_LIST.includes(e)) return a.setAttribute("invalid", ""), void this.addToast("Thats not a word stupid");
                        if (this.hardMode) {
                ...
                key: "submitGuess", value: function () {
                    if (this.gameStatus === Za && this.canInput) {
                        if (5 !== this.tileIndex) return this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("invalid", ""), void this.addToast("Not enough letters dumb ass");
                        this.evaluateRow()
                    }
                }
            }, {
    ...
    var ds = [["a", "b", "c", "d", "e", "f", "g", "h", "i", "j"], ["-", "k", "l", "m", "n", "o", "p", "q", "r", "s", "-"], ["↵", "t", "u", "v", "w", "x", "y", "z   ", "←"]],
        us = function (e) {
            r(t, e);
            var a = h(t);
...
`;
    ...
    Is.innerHTML = `
  <div class="countdown">
  <h1>Prove your self you dumbass</h1>
  </div>
</div>
<div class="share">
  <button id="share-button"><game-icon icon="share"></game-icon>
  </button>
<button id="refresh-button">New game<game-icon icon="refresh"></game-icon>
  </button>
</div>
`;
    var Ms = {
                    ...
                    p.appendChild(m), this.shadowRoot.querySelector("button#share-button").addEventListener("click", (function (a) {
                        ...
                        As(function (e) {
                            var a = e.evaluations, s = e.dayOffset, t = e.rowIndex, o = e.isHardMode, n = e.isWin,
                                ...
                                i = JSON.parse(window.localStorage.getItem(S)), l = "Wordle ".concat(s);
